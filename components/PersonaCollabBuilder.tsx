...
export default function PersonaCollabBuilder({
  ...
  return (
    <div className="space-y-16">
      ...
      <div>
        <h3 className="font-display text-2xl font-semibold tracking-tight text-[#E8E8F0] mb-6">Pre-built Bands</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {collaborations.map((collab) => {
            ...
            return (
              ...
              >
                {/* Band name */}
                <h4 className="font-display text-lg font-semibold tracking-tight text-[#E8E8F0] leading-tight">
                  {bandName}
                </h4>
      ...
      <div>
        <h3 className="font-display text-2xl font-semibold tracking-tight text-[#E8E8F0] mb-2">Custom Builder</h3>
